        ...
        >
            <Toolbar>
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
                    ...
                    {/* PROFILE */}
                    <Box onClick={handleProfileClick} sx={{ display: "flex", alignItems: "center", gap: 2, cursor: "pointer" }}>
            ...
            {/* PROFILE MENU */}
            <Menu anchorEl={profileAnchorEl} open={openProfileMenu} onClose={handleProfileClose}>
                <MenuItem onClick={() => handleMenuNavigation('/profile')}>
            ...
            >
                <List>
                    ...
                    {searchResults.employees.map(emp => (
                        <ListItem button key={emp.id} onClick={() => handleSearchResultClick("/employees")}>
                            <ListItemText primary={emp.name} secondary={emp.position} />
                        </ListItem>
                    ))}

                    {searchResults.tasks.map(task => (
                        <ListItem button key={task.id} onClick={() => handleSearchResultClick("/tasks")}>
                            <ListItemText primary={task.title} />
                        </ListItem>
                    ))}

                    {searchResults.requests.map(req => (
                        <ListItem button key={req.id} onClick={() => handleSearchResultClick(req.type === "leave" ? "/leave" : "/wfh")}>
                            <ListItemText primary={req.reason || "Request"} />
                        </ListItem>
                    ))}
